...
describe('SignupFormComponent', () => {
  ...
  function getFormControl(name) {
    return formControl?.controls[name];
  }
  ...
  function getFormFieldNames() {
    return formControl && Object.keys(formControl.controls);
  }
  ...
  it('has a form control', () => {
    expect(component.f).toBeTruthy('form should have NgForm control')
  })
